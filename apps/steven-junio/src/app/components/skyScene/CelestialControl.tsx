  ...
  return (
    <>
      ...
      <div
        ...
        className="pointer-events-none absolute right-4 top-[calc(1rem+env(safe-area-inset-top))] z-20 whitespace-nowrap rounded-full bg-slate-950/35 px-2.5 py-1 text-[11px] font-medium tracking-wide text-white/75 shadow-sm backdrop-blur-sm sm:text-xs"
      >
